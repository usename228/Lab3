...
5. Тепер, налаштувавши датчик, перейдемо до зчитування данних. Т.я. регістри мають 8-бітну структуру, а значення проекцій прискорень на осі - 16 бітні інтеджери, то дані зчитуємо з двох регістрів: 0x28 і 0x28 + sizeof(uint8_t) - наступний регістр.
